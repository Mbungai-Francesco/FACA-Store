	...
	public static void main(String[] args) {
		try {
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to FACA Store</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with FACA Store.<br>"
					...
					+ "branded items. As a Welcome gift for our New Customers we are providing additional 10% OFF Upto 1500 XAF for the first product purchase. To avail this offer you only have "
					+ "to enter the promo code given below.<br><br> PROMO CODE: "
					+ "<span class='greenText'>FACA500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
